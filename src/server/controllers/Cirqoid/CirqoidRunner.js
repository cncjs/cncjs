...
class CirqoidRunner extends events.EventEmitter {
    ...
    parse(data) {
        ...
        if (type === CirqoidLineParserResultStart) {
        ...
        if (type === CirqoidLineParserResultPosition) {
            const nextState = {
                ...this.state,
                pos: {
                    ...this.state.pos,
        ...
        if (type === CirqoidLineParserResultEcho) {
            this.emit('echo', payload);
            return;
        }
        if (type === CirqoidLineParserResultTemperature) {
            const nextState = {
                ...this.state,
                extruder: {
                    ...this.state.extruder,
