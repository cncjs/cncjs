...
class QuickAccessToolbar extends PureComponent {
  ...
  render() {
    return (
      <div className={styles.quickAccessToolbar} role="toolbar" aria-label={i18n._('Quick access toolbar')}>
        <ul className="nav navbar-nav" aria-label={i18n._('Quick access toolbar')}>
