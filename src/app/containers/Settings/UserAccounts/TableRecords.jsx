            ...
            render: (value, row, index) => {
              ...
              return (
                <ToggleSwitch
                  ...
                  size="sm"
                  title={title}
                  aria-label={i18n._('Enable account: {{name}}', { name: row.name })}
                  onChange={(event) => {
              ...
              return (
                <div>
                  <button
                    ...
                    aria-label={i18n._('Edit account: {{name}}', { name: row.name })}
                    onClick={(event) => {
                      actions.openModal(MODAL_UPDATE_RECORD, row);
                    }}
                  >
                  ...
                  <button
                    ...
                    aria-label={i18n._('Delete account: {{name}}', { name: row.name })}
                    onClick={(event) => {
                      portal(({ onClose }) => (
