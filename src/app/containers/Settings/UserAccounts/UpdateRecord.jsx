              ...
              <div className={styles.formGroup}>
                ...
                <div>
                  ...
                  <ToggleSwitch
                    ...
                    aria-label={i18n._('Account status')}
                    size="sm"
                    checked={enabled}
                  />
                </div>
              ...
              <div className={styles.formGroup}>
                ...
                <div className="clearfix">
                  <Input
                    ...
                    type="password"
                    name="oldPassword"
                    aria-label={changePassword ? i18n._('Old Password') : i18n._('Password')}
                    className={classNames(
                      'form-control',
              ...
              {changePassword ? (
                <div className={styles.formGroup}>
                  ...
                  <Input
                    ...
                    type="password"
                    name="password"
                    aria-label={i18n._('New Password')}
                    className={classNames(
                      'form-control',
                      styles.formControl,
                      styles.short
              ...
              {changePassword ? (
                <div className={styles.formGroup}>
                  ...
                  <Input
                    ...
                    name="confirm"
                    value=""
                    aria-label={i18n._('Confirm Password')}
                    className={classNames(
                      'form-control',
                      styles.formControl,
                      styles.short
