      ...
      {!!ovT && (
        <DigitalReadout label="T" value={ovT + '%'}>
          <button
            type="button"
            className="btn btn-default"
            aria-label="Trajectory planner override 100%"
            onClick={() => {
          ...
          <button
            type="button"
            className="btn btn-default"
            aria-label="Trajectory planner override 50%"
            onClick={() => {
          ...
          <button
            type="button"
            className="btn btn-default"
            aria-label="Trajectory planner override 25%"
            onClick={() => {
              controller.command('rapidOverride', 25);
            }}
          >
            <i className="fa fa-battery-quarter" aria-hidden="true" />
            <Space width="8" />
            25%
          </button>
        </DigitalReadout>
