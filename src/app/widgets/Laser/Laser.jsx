              ...
              <div className={styles.droBtnGroup}>
                <div className="btn-group btn-group-sm" role="group">
                  ...
                  <button
                    ...
                    style={{ padding: 5 }}
                    disabled={!canClick}
                    aria-label="Reset laser intensity override"
                    onClick={() => {
                  ...
                  <div className="table-form-col">
                    <div className="input-group input-group-sm" style={{ width: '100%' }}>
                      <input
                        ...
                        aria-label={i18n._('Test duration in milliseconds')}
                        value={test.duration}
                        min={0}
                        step={1}
                  ...
                  <div className="table-form-col">
                    <div className="input-group input-group-sm" style={{ width: '100%' }}>
                      ...
                      <input
                        ...
                        className="form-control"
                        style={{ borderRadius: 0 }}
                        aria-label={i18n._('Maximum S value')}
                        value={test.maxS}
                        min={0}
                        step={1}
