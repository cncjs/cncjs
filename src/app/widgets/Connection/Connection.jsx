              ...
              <div className="input-group-btn">
                {hasGrblController ? (
                  <button
                    ...
                    aria-pressed={controllerType === GRBL}
                    onClick={() => {
                ...
                {hasMarlinController ? (
                  <button
                    ...
                    disabled={!canChangeController}
                    aria-pressed={controllerType === MARLIN}
                    onClick={() => {
                ...
                {hasSmoothieController ? (
                  <button
                    ...
                    disabled={!canChangeController}
                    aria-pressed={controllerType === SMOOTHIE}
                    onClick={() => {
                ...
                {hasTinyGController ? (
                  <button
                    ...
                    disabled={!canChangeController}
                    aria-pressed={controllerType === TINYG}
                    onClick={() => {
          ...
          <div className="input-group input-group-sm">
            ...
            <div className="input-group-btn">
              <button
                ...
                aria-label={i18n._('Refresh ports')}
