...
class AxesWidget extends PureComponent {
  ...
  render() {
    ...
    return (
      <Widget fullscreen={isFullscreen} aria-label={i18n._('Axes')}>
        <Widget.Header>
          <Widget.Title>
          ...
          <Widget.Controls className={this.props.sortable.filterClassName}>
            ...
            >
              <Widget.Button
                ...
                aria-label={i18n._('Toggle keypad jogging')}
                aria-pressed={!!state.jog.keypad}
            ...
            <Widget.Button
              ...
              aria-label={i18n._('Toggle manual data input mode')}
              aria-pressed={!state.mdi.disabled}
            ...
            <Widget.Button
              title={i18n._('Edit')}
              aria-label={i18n._('Axes settings')}
              onClick={(event) => {
