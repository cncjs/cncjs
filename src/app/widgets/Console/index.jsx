...
class ConsoleWidget extends PureComponent {
  ...
  render() {
    ...
    return (
      <Widget fullscreen={isFullscreen} aria-label={i18n._('Console')}>
        <Widget.Header>
          <Widget.Title>
          ...
          <Widget.Controls className={this.props.sortable.filterClassName}>
            <Widget.Button
              ...
              aria-label={i18n._('Clear console')}
            ...
            <Widget.Button
              ...
              aria-label={!isFullscreen ? i18n._('Enter Full Screen') : i18n._('Exit Full Screen')}
            ...
            >
              ...
              <Widget.DropdownMenuItem eventKey="clearSelection">
                <i className="fa fa-fw fa-window-close-o" aria-hidden="true" />
                <Space width="4" />
