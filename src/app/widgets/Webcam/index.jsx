...
class WebcamWidget extends PureComponent {
  ...
  render() {
    ...
    return (
      <Widget fullscreen={isFullscreen} aria-label={i18n._('Webcam')}>
        <Widget.Header>
          <Widget.Title>
          ...
          <Widget.Controls className={this.props.sortable.filterClassName}>
            <Widget.Button
              ...
              aria-label={disabled ? i18n._('Enable Webcam') : i18n._('Disable Webcam')}
            ...
            <Widget.Button
              ...
              aria-label={i18n._('Refresh webcam')}
            ...
            <Widget.Button
              title={i18n._('Edit')}
              aria-label={i18n._('Webcam settings')}
              onClick={(event) => {
