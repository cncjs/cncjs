...
test('SmoothieRunner', (t) => {
  ...
  // RX Buffer        | 8
  // Limit Pins       | 16
  t.test('SmoothieRunnerLineParserResultStatus: all zeroes in the mask ($10=0)', (t) => {
  ...
  t.test('SmoothieRunnerLineParserResultStatus: old status format', (t) => {
    t.test('6-axis', (t) => {
      const runner = new SmoothieRunner();
      runner.on('status', ({ raw, ...status }) => {
  ...
  t.test('SmoothieRunnerLineParserResultStatus: new status format', (t) => {
    t.test('6-axis', (t) => {
      const runner = new SmoothieRunner();
      runner.on('status', ({ raw, ...status }) => {
  ...
  t.test('SmoothieRunnerLineParserResultOk', (t) => {
    const runner = new SmoothieRunner();
    runner.on('ok', ({ raw }) => {
      t.equal(raw, 'ok');
      t.end();
  ...
  t.test('SmoothieRunnerLineParserResultError', (t) => {
    const runner = new SmoothieRunner();
  ...
  t.test('SmoothieRunnerLineParserResultAlarm', (t) => {
    const runner = new SmoothieRunner();
  ...
  t.test('SmoothieRunnerLineParserResultParserState', (t) => {
    test('#1', (t) => {
      const runner = new SmoothieRunner();
  ...
  t.test('SmoothieRunnerLineParserResultParameters:G54,G55,G56,G57,G58,G59,G28,G30,G92', (t) => {
    const lines = [
  ...
  t.test('SmoothieRunnerLineParserResultParameters:TLO', (t) => {
    const runner = new SmoothieRunner();
    runner.on('parameters', ({ name, value, raw }) => {
  ...
  t.test('SmoothieRunnerLineParserResultParameters:PRB', (t) => {
    const runner = new SmoothieRunner();
    runner.on('parameters', ({ name, value, raw }) => {
  ...
  t.test('SmoothieRunnerLineParserResultVersion', (t) => {
    const runner = new SmoothieRunner();
  ...
  t.test('Not supported output format', (t) => {
    const runner = new SmoothieRunner();
