...
import TinyGRunner from 'server/controllers/TinyG/TinyGRunner';

test('TinyGRunner', (t) => {
  t.test('TinyGParserResultMotorTimeout', (t) => {
  ...
  t.test('TinyGParserResultPowerManagement', (t) => {
  ...
  t.test('TinyGParserResultQueueReports', (t) => {
    t.test('{"qr":48}', (t) => {
      const runner = new TinyGRunner();
  ...
  t.test('TinyGParserResultStatusReports', (t) => {
  ...
  t.test('TinyGParserResultSystemSettings', (t) => {
  ...
  t.test('TinyGParserResultOverrides', (t) => {
  ...
  t.test('TinyGParserResultReceiveReports', (t) => {
    t.test('{"r":{},"f":[1,0,4]}', (t) => {
      const runner = new TinyGRunner();
      runner.on('r', (r) => {
        t.same(r, {});
